 ...
 */
public class RandomUserForm extends javax.swing.JFrame implements IObserver{
  ...
  private void btn1Clicked(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1Clicked
    ...
    randomUserControl.addCreep(this);
  ...
  // End of variables declaration//GEN-END:variables
    ...
    @Override
    public void dataReady(RandomUser user) {
        textFirstName.setText(user.getFirstName());
    textLastName.setText(user.getLastName());
    textStreet.setText(user.getStreet());
